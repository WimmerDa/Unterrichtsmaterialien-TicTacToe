...
def computer_on_turn():
    # TODO: Implementiere die if-elif-else-Bedingungen für MIDDLE, EDGE und CORNER,
    #       und rufe die entsprechenden Funktionen (case_middle, case_edge, case_corner) auf
    #       Lösche pass
    pass
...
def computer_wins():
    ...
    if (computer[1] and computer[2] or computer[3] and computer[6] or computer[8] and computer[4]) and not blocked_boxes[0]:
        computer_clicks(OL)
    # TODO: Es wurde auf weitere Möglichkeiten vergessen. Ergänze die restlichen elif-Abfragen. Achte auf alle Fälle! (MM!)
...
def case_edge():
    if cross_count == 1:
        # TODO: Rufe die Funktion auf, ie ein Kreuz MM setzt
        #       Lösche pass
        pass
    else:
