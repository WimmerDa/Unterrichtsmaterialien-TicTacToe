...
def reset():
    ...
    # TODO: Weise der Variable 'blocked_boxes' eine Liste mit 9 Nullen zu.
    #blocked_boxes = [0, 0, 0, 0, 0, 0, 
    # TODO: Weise den Variablen 'computer' und 'player' jeweils eine Liste mit 9 Nullen zu.
    #computer = [0, 0, 0, 0, 0, 
    #player = 
    # TODO: Setze 'on_turn' auf den Spieler, der das Spiel beginnt (PLAYER).
    #on_turn = 
    # TODO: Setze 'cross_count' auf 0.
    #cross_count = 
    # TODO: Setze 'case' auf den Anfangszustand (ND).
    #case = 
    # TODO: Setze 'winner' auf den Wert, der anzeigt, dass das Spiel noch läuft (z.B. IN_GAME).
    #winner = 
    # TODO: Setze 'game_stopped' auf 0, um anzuzeigen, dass das Spiel nicht gestoppt ist.
    #game_stopped = 
...
def computer_on_turn():
    if case == MIDDLE:
        ...
        # TODO: Rufe die Funktion auf, die den Fall für eine Kante behandelt (case_edge)
        #       Lösche pass
        pass
    else:
        # TODO: Rufe die Funktion auf, die den Fall für eine Ecke behandelt (case_corner)
        #       Lösche pass
        pass
...
def case_middle():
    if cross_count == 1:
        ...
        # TODO: Rufe die Funktion auf, die den Computer zum Sieg führt
        #       Lösche pass
        pass
        if on_turn == COMPUTER:
            # TODO: Rufe die Funktion auf, die den Sieg des Spielers abwehrt
            #       Lösche pass
            pass
        if on_turn == COMPUTER:
...
def check_computer_wins():
    ...
    # TODO: Es werden erst sieben Fälle betrachtet. Erweitere die if-Abfrage mit dem Fall:
    #       computer[0] and computer[4] and computer[8]
...
def check_player_wins():
    ...
    #       Lösche pass
    #       Gleiche Funktion wie check_computer_wins. Anstelle von computer wird nun die player Liste betrachtet.
    pass
...
def check_draw():
    ...
    # TODO: In der if-Abfrage wurde auf eine Box vergessen. Ergänze diese.
    #       Setzte winner = NO_WINNER
    #       Lösche pass
    if blocked_boxes[0] and blocked_boxes[1] and blocked_boxes[2] and \
            ...
            blocked_boxes[6] and blocked_boxes[8]:
        pass
